...
l(),d={type:"textfield",desc:"",preProcessor:function(){},initialize:function(){},setValuePre:function(a){return a},getValuePost:function(a){return a},containerStyle:{li_class:"",li_style:""},assistButtons:{}};if(a.pjfAttr){var b=A(d,a);b.id=c;b.pjfAttr.dom="dom_"+b.id;b.preProcessor=z[b.type]}else throw Error("\u521d\u59cb\u5316PJF\u7ec4\u4ef6\u7684\u5c5e\u6027\u9700\u653e\u7f6e\u5728pjfAttr\u8282\u70b9\u4e0b");b.buttons instanceof Array&&0<b.buttons.length&&(b.containerStyle={li_class:"width_auto",
...
instantiate:function(){var a=this;console.log(b.id);b.label=new PJF.ui.label({dom:"label_"+b.id});b.widget=new v[b.type](b.pjfAttr);for(var c in b.assistButtons){var d=b.assistButtons[c];new PJF.ui.linkButton({dom:"button_"+c,name:d.desc,style:"assistant",onclick:function(b){return function(){b(a)}}(d.onclick)})}b.preProcessor();b.initialize()},setRequired:function(a){PJF.html.displayArea("star_"+b.id,a);b.widget.setRequired&&b.widget.setRequired(a)},setDisplay:function(a){PJF.html.displayArea(b.id+
